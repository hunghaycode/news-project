...
class AdminAuthenticationController extends Controller
{
  ...
  public function sendResetLink(SendResetLinkRequest $request)
  {
    ...
    return redirect()->back()->with('success', 'Một mail đã đc gửi đến email của bạn');
  }
  ...
  public function handleResetPassword(AdminResetPasswordRequest $request)
  {
    ...
    if (!$admin) {
      return back()->with('error', 'admin.token is invalid');
    }
    ...
    return redirect()->route('admin.login')->with('success', 'admin Password reset successfully');
  }
}
